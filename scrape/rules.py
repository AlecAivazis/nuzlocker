...
HARDER_RULES = [
    ("singleCenterUse",         "Single Pokémon Center Use"),
    ("noCenters",               "No Pokémon Centers"),
    ...
    ("banSpecies",              "Ban Specific Pokémon"),
    ("tierBans",                "Tier Bans"),
    ("noStarter",               "No Starter"),
    ("noGifts",                 "No Gift Pokémon"),

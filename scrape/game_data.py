...
_HOENN_E4_RS = [
    ...
    {"name":"May",    "class":"rival",  "page":"May (game)",
     "rival_starter_map": {
         "torchic":"treecko","combusken":"treecko","blaziken":"treecko",
         "mudkip":"torchic","marshtomp":"torchic","swampert":"torchic",
         "treecko":"mudkip","grovyle":"mudkip","sceptile":"mudkip",
...
_SINNOH_E4 = [
    ...
    {"name":"Barry",  "class":"rival",  "page":"Barry (game)",
     "rival_starter_map": {
...
# Gym 8 differs: Black has Drayden, White has Iris (both Dragon)
_UNOVA_GYMS_BLACK = _UNOVA_GYMS_BW_SHARED + [
    {"name":"Drayden", "class":"gym_leader","specialty":"dragon","badge":"Legend Badge","order":8,"page":"Drayden"},
]
_UNOVA_GYMS_WHITE = _UNOVA_GYMS_BW_SHARED + [
    {"name":"Iris",    "class":"gym_leader","specialty":"dragon","badge":"Legend Badge","order":8,"page":"Iris"},
]
# BW2 has a completely different gym lineup
_UNOVA_GYMS_BW2 = [
    {"name":"Cheren",  "class":"gym_leader","specialty":"normal", "badge":"Basic Badge",  "order":1,"page":"Cheren"},
    {"name":"Roxie",   "class":"gym_leader","specialty":"poison", "badge":"Toxic Badge",  "order":2,"page":"Roxie"},
    {"name":"Burgh",   "class":"gym_leader","specialty":"bug",    "badge":"Insect Badge", "order":3,"page":"Burgh"},
    {"name":"Elesa",   "class":"gym_leader","specialty":"electric","badge":"Bolt Badge",  "order":4,"page":"Elesa"},
    {"name":"Clay",    "class":"gym_leader","specialty":"ground", "badge":"Quake Badge",  "order":5,"page":"Clay"},
    {"name":"Skyla",   "class":"gym_leader","specialty":"flying", "badge":"Jet Badge",    "order":6,"page":"Skyla"},
    {"name":"Drayden", "class":"gym_leader","specialty":"dragon", "badge":"Legend Badge", "order":7,"page":"Drayden"},
    {"name":"Marlon",  "class":"gym_leader","specialty":"water",  "badge":"Wave Badge",   "order":8,"page":"Marlon"},
]
_UNOVA_E4_BW = [
...
_KALOS_E4 = [
    ...
    {"name":"Serena",  "class":"rival",  "page":"Serena (game)",
     "rival_starter_map": {
         "fennekin":"chespin","braixen":"chespin","delphox":"chespin",
         "froakie":"fennekin","frogadier":"fennekin","greninja":"fennekin",
         "chespin":"froakie","quilladin":"froakie","chesnaught":"froakie",
...
TRAINER_DEFS: dict[str, list[dict]] = {
    ...
    "black":        _UNOVA_GYMS_BLACK  + _UNOVA_E4_BW,
    "white":        _UNOVA_GYMS_WHITE  + _UNOVA_E4_BW,
    "black-2":      _UNOVA_GYMS_BW2   + _UNOVA_E4_BW2,
    "white-2":      _UNOVA_GYMS_BW2   + _UNOVA_E4_BW2,
...
ROUTE_ORDER: dict[str, list[dict]] = {
    ...
    "sun": [
        ...
        _r(37, "ulaula-meadow",     "Ula'ula Meadow"),
...
_GSC_CAVE_MAPS: list[dict] = [
    _loc("sprout-tower", "Sprout Tower", [
        ...
        _floor("sprout-tower-2f", "2F", "Sprout Tower 2F GSC.png", pokeapi_areas=["sprout-tower-2f"]),
        _floor("sprout-tower-3f", "3F", "Sprout Tower 3F GSC.png", pokeapi_areas=["sprout-tower-3f"]),
    ]),
    _loc("union-cave", "Union Cave", [
        _floor("union-cave-1f",  "1F",  "Union Cave 1F GSC.png",  pokeapi_areas=["union-cave-1f"]),
        _floor("union-cave-b1f", "B1F", "Union Cave B1F GSC.png", pokeapi_areas=["union-cave-b1f"]),
        _floor("union-cave-b2f", "B2F", "Union Cave B2F GSC.png", pokeapi_areas=["union-cave-b2f"]),
    ]),
    _loc("slowpoke-well", "Slowpoke Well", [
        # PokeAPI names the in-cave floors "1f"/"b1f"; game labels them B1F/B2F
        _floor("slowpoke-well-b1f", "B1F", "Slowpoke Well B1F GSC.png", pokeapi_areas=["slowpoke-well-1f"]),
        _floor("slowpoke-well-b2f", "B2F", "Slowpoke Well B2F GSC.png", pokeapi_areas=["slowpoke-well-b1f"]),
    ]),
    _loc("ilex-forest", "Ilex Forest", [
        _floor("ilex-forest", "Forest", "Ilex Forest GSC.png", pokeapi_areas=["ilex-forest-area"]),
    ]),
    _loc("mt-mortar", "Mt. Mortar", [
        _floor("mt-mortar-entrance",   "Entrance",   "Mt Mortar Entrance GSC.png",   pokeapi_areas=["mt-mortar-1f"]),
        _floor("mt-mortar-basement",   "Basement",   "Mt Mortar Basement GSC.png",   pokeapi_areas=["mt-mortar-b1f"]),
        _floor("mt-mortar-upper-cave", "Upper Cave", "Mt Mortar Upper Cave GSC.png", pokeapi_areas=["mt-mortar-upper-cave"]),
        _floor("mt-mortar-lower-cave", "Lower Cave", "Mt Mortar Lower Cave GSC.png", pokeapi_areas=["mt-mortar-lower-cave"]),
    ]),
    _loc("burned-tower", "Burned Tower", [
        _floor("burned-tower-1f",  "1F",  "Burned Tower 1F GSC.png",  pokeapi_areas=["burned-tower-1f"]),
        _floor("burned-tower-b1f", "B1F", "Burned Tower B1F GSC.png", pokeapi_areas=["burned-tower-b1f"]),
    ]),
    _loc("bell-tower", "Bell Tower", [
        _floor("bell-tower-1f",  "1F",  "Bell Tower 1F GSC.png"),
        _floor("bell-tower-2f",  "2F",  "Bell Tower 2F GSC.png",  pokeapi_areas=["bell-tower-2f"]),
        _floor("bell-tower-3f",  "3F",  "Bell Tower 3F GSC.png",  pokeapi_areas=["bell-tower-3f"]),
        _floor("bell-tower-4f",  "4F",  "Bell Tower 4F GSC.png",  pokeapi_areas=["bell-tower-4f"]),
        _floor("bell-tower-5f",  "5F",  "Bell Tower 5F GSC.png",  pokeapi_areas=["bell-tower-5f"]),
        _floor("bell-tower-6f",  "6F",  "Bell Tower 6F GSC.png",  pokeapi_areas=["bell-tower-6f"]),
        _floor("bell-tower-7f",  "7F",  "Bell Tower 7F GSC.png",  pokeapi_areas=["bell-tower-7f"]),
        _floor("bell-tower-8f",  "8F",  "Bell Tower 8F GSC.png",  pokeapi_areas=["bell-tower-8f"]),
        _floor("bell-tower-9f",  "9F",  "Bell Tower 9F GSC.png",  pokeapi_areas=["bell-tower-9f"]),
        _floor("bell-tower-10f", "10F", "Bell Tower 10F GSC.png"),
    ]),
    _loc("dark-cave", "Dark Cave", [
        _floor("dark-cave-1", "Violet City Side",     "Dark Cave 1 GSC.png", pokeapi_areas=["dark-cave-violet-city-entrance"]),
        _floor("dark-cave-2", "Blackthorn City Side", "Dark Cave 2 GSC.png", pokeapi_areas=["dark-cave-blackthorn-city-entrance"]),
    ]),
    _loc("ice-path", "Ice Path", [
        _floor("ice-path-1f",  "1F",  "Ice Path 1F GSC.png",  pokeapi_areas=["ice-path-1f"]),
        _floor("ice-path-b1f", "B1F", "Ice Path B1F GSC.png", pokeapi_areas=["ice-path-b1f"]),
        _floor("ice-path-b2f", "B2F", "Ice Path B2F GSC.png", pokeapi_areas=["ice-path-b2f"]),
        _floor("ice-path-b3f", "B3F", "Ice Path B3F GSC.png", pokeapi_areas=["ice-path-b3f"]),
    ]),
    _loc("dragons-den", "Dragon's Den", [
        _floor("dragons-den-entrance", "Entrance", "Dragons Den Entrance GSC.png"),
        _floor("dragons-den-interior", "Interior", "Dragons Den GSC.png",    pokeapi_areas=["dragons-den-area"]),
    ]),
    _loc("whirl-islands", "Whirl Islands", [
        _floor("whirl-islands-1f-nw", "1F (NW Island)", "Whirl Islands 1F NW GSC.png", pokeapi_areas=["whirl-islands-1f"]),
        ...
        _floor("whirl-islands-b1f",   "B1F",            "Whirl Islands B1F GSC.png",   pokeapi_areas=["whirl-islands-b1f"]),
        _floor("whirl-islands-b2f",   "B2F",            "Whirl Islands B2F GSC.png",   pokeapi_areas=["whirl-islands-b2f"]),
        _floor("whirl-islands-b3f",   "B3F",            "Whirl Islands B3F GSC.png",   pokeapi_areas=["whirl-islands-b3f"]),
    ]),
    _loc("mt-silver", "Mt. Silver", [
        _floor("mt-silver-exterior", "Exterior", "Mt. Silver Exterior GSC.png", pokeapi_areas=["mt-silver-outside"]),
        _floor("mt-silver-1f",       "1F",       "Mt. Silver 1F GSC.png",       pokeapi_areas=["mt-silver-1f"]),
        _floor("mt-silver-2f",       "2F",       "Mt. Silver 2F GSC.png",       pokeapi_areas=["mt-silver-2f"]),
        _floor("mt-silver-3f",       "3F",       "Mt. Silver 3F GSC.png"),
        _floor("mt-silver-summit",   "Summit",   "Mt. Silver Summit GSC.png",   pokeapi_areas=["mt-silver-top"]),
    ]),
    # Kanto dungeons — Mt. Moon has B1F/B2F in GSC (no Square; that's HGSS-only)
    _loc("mt-moon", "Mt. Moon", [
        _floor("mt-moon-1f",    "1F",    "Mt Moon 1F GSC.png",    pokeapi_areas=["mt-moon-1f"]),
    ...
    _loc("rock-tunnel", "Rock Tunnel", [
        _floor("rock-tunnel-1", "1F",  "Rock Tunnel 1 GSC.png", pokeapi_areas=["rock-tunnel-1f"]),
        _floor("rock-tunnel-2", "B1F", "Rock Tunnel 2 GSC.png", pokeapi_areas=["rock-tunnel-b1f"]),
    ]),
    _loc("victory-road-kanto", "Victory Road", [
        _floor("victory-road-kanto-1f", "1F", "Victory Road 1F GSC.png", pokeapi_areas=["kanto-victory-road-1-1f"]),
        _floor("victory-road-kanto-2f", "2F", "Victory Road 2F GSC.png", pokeapi_areas=["kanto-victory-road-1-2f"]),
        _floor("victory-road-kanto-3f", "3F", "Victory Road 3F GSC.png", pokeapi_areas=["kanto-victory-road-1-3f"]),
    ]),
...
_HGSS_CAVE_MAPS: list[dict] = [
    _loc("sprout-tower", "Sprout Tower", [
        ...
        _floor("sprout-tower-2f", "2F", "Sprout Tower 2F HGSS.png", pokeapi_areas=["sprout-tower-2f"]),
        _floor("sprout-tower-3f", "3F", "Sprout Tower 3F HGSS.png", pokeapi_areas=["sprout-tower-3f"]),
    ]),
    _loc("union-cave", "Union Cave", [
        _floor("union-cave-1f",  "1F",  "Union Cave 1F HGSS.png",  pokeapi_areas=["union-cave-1f"]),
        _floor("union-cave-b1f", "B1F", "Union Cave B1F HGSS.png", pokeapi_areas=["union-cave-b1f"]),
        _floor("union-cave-b2f", "B2F", "Union Cave B2F HGSS.png", pokeapi_areas=["union-cave-b2f"]),
    ]),
    _loc("slowpoke-well", "Slowpoke Well", [
        # PokeAPI names the in-cave floors "1f"/"b1f"; game labels them B1F/B2F
        _floor("slowpoke-well-b1f", "B1F", "Slowpoke Well B1F HGSS.png", pokeapi_areas=["slowpoke-well-1f"]),
        _floor("slowpoke-well-b2f", "B2F", "Slowpoke Well B2F HGSS.png", pokeapi_areas=["slowpoke-well-b1f"]),
    ]),
    _loc("ilex-forest", "Ilex Forest", [
        _floor("ilex-forest", "Forest", "Ilex Forest HGSS.png", pokeapi_areas=["ilex-forest-area"]),
    ]),
    _loc("mt-mortar", "Mt. Mortar", [
        _floor("mt-mortar-entrance",   "Entrance",   "Mt Mortar Entrance HGSS.png",   pokeapi_areas=["mt-mortar-1f"]),
        _floor("mt-mortar-basement",   "Basement",   "Mt Mortar Basement HGSS.png",   pokeapi_areas=["mt-mortar-b1f"]),
        _floor("mt-mortar-upper-cave", "Upper Cave", "Mt Mortar Upper Cave HGSS.png", pokeapi_areas=["mt-mortar-upper-cave"]),
        _floor("mt-mortar-lower-cave", "Lower Cave", "Mt Mortar Lower Cave HGSS.png", pokeapi_areas=["mt-mortar-lower-cave"]),
    ]),
    _loc("burned-tower", "Burned Tower", [
        _floor("burned-tower-1f",  "1F",  "Burned Tower 1F HGSS.png",  pokeapi_areas=["burned-tower-1f"]),
        _floor("burned-tower-b1f", "B1F", "Burned Tower B1F HGSS.png", pokeapi_areas=["burned-tower-b1f"]),
    ]),
    _loc("bell-tower", "Bell Tower", [
        _floor("bell-tower-1f",  "1F",  "Bell Tower 1F HGSS.png"),
        _floor("bell-tower-2f",  "2F",  "Bell Tower 2F HGSS.png",  pokeapi_areas=["bell-tower-2f"]),
        _floor("bell-tower-3f",  "3F",  "Bell Tower 3F HGSS.png",  pokeapi_areas=["bell-tower-3f"]),
        _floor("bell-tower-4f",  "4F",  "Bell Tower 4F HGSS.png",  pokeapi_areas=["bell-tower-4f"]),
        _floor("bell-tower-5f",  "5F",  "Bell Tower 5F HGSS.png",  pokeapi_areas=["bell-tower-5f"]),
        _floor("bell-tower-6f",  "6F",  "Bell Tower 6F HGSS.png",  pokeapi_areas=["bell-tower-6f"]),
        _floor("bell-tower-7f",  "7F",  "Bell Tower 7F HGSS.png",  pokeapi_areas=["bell-tower-7f"]),
        _floor("bell-tower-8f",  "8F",  "Bell Tower 8F HGSS.png",  pokeapi_areas=["bell-tower-8f"]),
        _floor("bell-tower-9f",  "9F",  "Bell Tower 9F HGSS.png",  pokeapi_areas=["bell-tower-9f"]),
        _floor("bell-tower-10f", "10F", "Bell Tower 10F HGSS.png", pokeapi_areas=["bell-tower-10f"]),
    ]),
    _loc("dark-cave", "Dark Cave", [
        _floor("dark-cave-1", "Violet City Side",     "Dark Cave 1 HGSS.png", pokeapi_areas=["dark-cave-violet-city-entrance"]),
        _floor("dark-cave-2", "Blackthorn City Side", "Dark Cave 2 HGSS.png", pokeapi_areas=["dark-cave-blackthorn-city-entrance"]),
    ]),
    _loc("ice-path", "Ice Path", [
        _floor("ice-path-1f",  "1F",  "Ice Path 1F HGSS.png",  pokeapi_areas=["ice-path-1f"]),
        _floor("ice-path-b1f", "B1F", "Ice Path B1F HGSS.png", pokeapi_areas=["ice-path-b1f"]),
        _floor("ice-path-b2f", "B2F", "Ice Path B2F HGSS.png", pokeapi_areas=["ice-path-b2f"]),
        _floor("ice-path-b3f", "B3F", "Ice Path B3F HGSS.png", pokeapi_areas=["ice-path-b3f"]),
    ]),
    _loc("dragons-den", "Dragon's Den", [
        _floor("dragons-den-entrance", "Entrance", "Dragons Den Entrance HGSS.png"),
        _floor("dragons-den-interior", "Interior", "Dragons Den HGSS.png",    pokeapi_areas=["dragons-den-area"]),
    ]),
    _loc("whirl-islands", "Whirl Islands", [
        _floor("whirl-islands-1f-nw", "1F (NW Island)", "Whirl Islands 1F NW HGSS.png", pokeapi_areas=["whirl-islands-1f"]),
        ...
        _floor("whirl-islands-b1f",   "B1F",            "Whirl Islands B1F HGSS.png",   pokeapi_areas=["whirl-islands-b1f"]),
        _floor("whirl-islands-b2f",   "B2F",            "Whirl Islands B2F HGSS.png",   pokeapi_areas=["whirl-islands-b2f"]),
        _floor("whirl-islands-b3f",   "B3F",            "Whirl Islands B3F HGSS.png",   pokeapi_areas=["whirl-islands-b3f"]),
    ]),
    _loc("mt-silver", "Mt. Silver", [
        _floor("mt-silver-exterior", "Exterior", "Mt. Silver Exterior HGSS.png", pokeapi_areas=["mt-silver-outside", "mt-silver-mountainside"]),
        _floor("mt-silver-1f",       "1F",       "Mt. Silver 1F HGSS.png",       pokeapi_areas=["mt-silver-1f", "mt-silver-1f-top"]),
        _floor("mt-silver-2f",       "2F",       "Mt. Silver 2F HGSS.png",       pokeapi_areas=["mt-silver-2f"]),
        _floor("mt-silver-3f",       "3F",       "Mt. Silver 3F HGSS.png",       pokeapi_areas=["mt-silver-3f"]),
        _floor("mt-silver-summit",   "Summit",   "Mt. Silver Summit HGSS.png",   pokeapi_areas=["mt-silver-4f", "mt-silver-top"]),
    ]),
    # Kanto dungeons
    _loc("mt-moon", "Mt. Moon", [
        _floor("mt-moon-1f",     "1F",     "Mt Moon 1F HGSS.png",     pokeapi_areas=["mt-moon-1f", "mt-moon-2f"]),
        _floor("mt-moon-square", "Square", "Mt Moon Square HGSS.png", pokeapi_areas=["mt-moon-mt-moon-square"]),
    ]),
    _loc("rock-tunnel", "Rock Tunnel", [
        _floor("rock-tunnel-1", "1F",  "Rock Tunnel 1 HGSS.png", pokeapi_areas=["rock-tunnel-1f"]),
        _floor("rock-tunnel-2", "B1F", "Rock Tunnel 2 HGSS.png", pokeapi_areas=["rock-tunnel-b1f"]),
    ]),
    _loc("victory-road-kanto", "Victory Road", [
        _floor("victory-road-kanto-1f", "1F", "Victory Road 1F HGSS.png", pokeapi_areas=["kanto-victory-road-1-1f"]),
        _floor("victory-road-kanto-2f", "2F", "Victory Road 2F HGSS.png", pokeapi_areas=["kanto-victory-road-1-2f"]),
        _floor("victory-road-kanto-3f", "3F", "Victory Road 3F HGSS.png", pokeapi_areas=["kanto-victory-road-1-3f"]),
    ]),
    _loc("seafoam-islands", "Seafoam Islands", [
        _floor("seafoam-islands-1f",  "1F",  "Seafoam Islands 1F HGSS.png",  pokeapi_areas=["seafoam-islands-1f"]),
        _floor("seafoam-islands-b1f", "B1F", "Seafoam Islands B1F HGSS.png", pokeapi_areas=["seafoam-islands-b1f"]),
        _floor("seafoam-islands-b2f", "B2F", "Seafoam Islands B2F HGSS.png", pokeapi_areas=["seafoam-islands-b2f"]),
        _floor("seafoam-islands-b3f", "B3F", "Seafoam Islands B3F HGSS.png", pokeapi_areas=["seafoam-islands-b3f"]),
        _floor("seafoam-islands-b4f", "B4F", "Seafoam Islands B4F HGSS.png", pokeapi_areas=["seafoam-islands-b4f"]),
    ]),
    _loc("cerulean-cave", "Cerulean Cave", [
        _floor("cerulean-cave-1f",  "1F",  "Cerulean Cave 1F HGSS.png",  pokeapi_areas=["cerulean-cave-1f"]),
        _floor("cerulean-cave-b1f", "B1F", "Cerulean Cave B1F HGSS.png", pokeapi_areas=["cerulean-cave-b1f"]),
        _floor("cerulean-cave-2f",  "2F",  "Cerulean Cave 2F HGSS.png",  pokeapi_areas=["cerulean-cave-2f"]),
    ]),
]

_RED_CAVE_MAPS: list[dict] = [
    _loc("mt-moon", "Mt. Moon", [
        _floor("mt-moon-1f",  "1F",  "Mt. Moon 1F RBY.png",  pokeapi_areas=["mt-moon-1f"]),
        _floor("mt-moon-b1f", "B1F", "Mt. Moon B1F RBY.png", pokeapi_areas=["mt-moon-b1f"]),
        _floor("mt-moon-b2f", "B2F", "Mt. Moon B2F RBY.png", pokeapi_areas=["mt-moon-b2f"]),
    ]),
    _loc("rock-tunnel", "Rock Tunnel", [
        _floor("rock-tunnel-1f",  "1F",  "Rock Tunnel 1F RBY.png",  pokeapi_areas=["rock-tunnel-1f"]),
        _floor("rock-tunnel-b1f", "B1F", "Rock Tunnel B1F RBY.png", pokeapi_areas=["rock-tunnel-b1f"]),
    ]),
    _loc("pokemon-tower", "Pokémon Tower", [
        ...
        _floor("pokemon-tower-3f", "3F", "Pokémon Tower 3F RBY.png", pokeapi_areas=["pokemon-tower-3f"]),
        _floor("pokemon-tower-4f", "4F", "Pokémon Tower 4F RBY.png", pokeapi_areas=["pokemon-tower-4f"]),
        _floor("pokemon-tower-5f", "5F", "Pokémon Tower 5F RBY.png", pokeapi_areas=["pokemon-tower-5f"]),
        _floor("pokemon-tower-6f", "6F", "Pokémon Tower 6F RBY.png", pokeapi_areas=["pokemon-tower-6f"]),
        _floor("pokemon-tower-7f", "7F", "Pokémon Tower 7F RBY.png", pokeapi_areas=["pokemon-tower-7f"]),
    ]),
    ...
    _loc("victory-road", "Victory Road", [
        # PokeAPI uses "2" series for RBY encounters; "1" series is HGSS Kanto
        _floor("victory-road-1f", "1F", "Victory Road 1F RBY.png", pokeapi_areas=["kanto-victory-road-2-1f"]),
        _floor("victory-road-2f", "2F", "Victory Road 2F RBY.png", pokeapi_areas=["kanto-victory-road-2-2f"]),
        _floor("victory-road-3f", "3F", "Victory Road 3F RBY.png", pokeapi_areas=["kanto-victory-road-2-3f"]),
    ]),
    _loc("seafoam-islands", "Seafoam Islands", [
        _floor("seafoam-islands-1f",  "1F",  "Seafoam Islands 1F RBY.png",  pokeapi_areas=["seafoam-islands-1f"]),
        _floor("seafoam-islands-b1f", "B1F", "Seafoam Islands B1F RBY.png", pokeapi_areas=["seafoam-islands-b1f"]),
        _floor("seafoam-islands-b2f", "B2F", "Seafoam Islands B2F RBY.png", pokeapi_areas=["seafoam-islands-b2f"]),
        _floor("seafoam-islands-b3f", "B3F", "Seafoam Islands B3F RBY.png", pokeapi_areas=["seafoam-islands-b3f"]),
        _floor("seafoam-islands-b4f", "B4F", "Seafoam Islands B4F RBY.png", pokeapi_areas=["seafoam-islands-b4f"]),
    ]),
    _loc("cerulean-cave", "Cerulean Cave", [
        _floor("cerulean-cave-1f",  "1F",  "Cerulean Cave 1F RBY.png",  pokeapi_areas=["cerulean-cave-1f"]),
        _floor("cerulean-cave-b1f", "B1F", "Cerulean Cave B1F RBY.png", pokeapi_areas=["cerulean-cave-b1f"]),
        _floor("cerulean-cave-2f",  "2F",  "Cerulean Cave 2F RBY.png",  pokeapi_areas=["cerulean-cave-2f"]),
    ]),
    _loc("power-plant", "Power Plant", [
        _floor("power-plant", "Interior", "Power Plant RBY.png", pokeapi_areas=["kanto-power-plant-area"]),
    ]),
    # FRLG-only locations (not present in RBY)
    _loc("mt-ember", "Mt. Ember", [
        _floor("mt-ember-exterior",       "Exterior",       "Mt Ember FRLG.png",              pokeapi_areas=["mt-ember-area"]),
        _floor("mt-ember-summit",         "Summit",         "Mt. Ember Summit FRLG.png",      pokeapi_areas=["mt-ember-summit"]),
        _floor("mt-ember-summit-path-1f", "Summit Path 1F", "Mt. Ember Summit Path 1F FRLG.png", pokeapi_areas=["mt-ember-cave"]),
        _floor("mt-ember-summit-path-2f", "Summit Path 2F", "Mt. Ember Summit Path 2F FRLG.png", pokeapi_areas=["mt-ember-inside"]),
        _floor("mt-ember-summit-path-3f", "Summit Path 3F", "Mt. Ember Summit Path 3F FRLG.png", pokeapi_areas=["mt-ember-1f-cave-behind-team-rocket"]),
        _floor("mt-ember-ruby-path-b1f",  "Ruby Path B1F",  "Ruby Path B1F FRLG.png",         pokeapi_areas=["mt-ember-b1f"]),
        _floor("mt-ember-ruby-path-b3f",  "Ruby Path B3F",  "Ruby Path B3F FRLG.png",         pokeapi_areas=["mt-ember-b2f"]),
        _floor("mt-ember-ruby-path-b4f",  "Ruby Path B4F",  "Ruby Path B4F FRLG.png",         pokeapi_areas=["mt-ember-b3f"]),
...
_EMERALD_CAVE_MAPS: list[dict] = [
    _loc("granite-cave", "Granite Cave", [
        _floor("granite-cave-1f",  "1F",  "Granite Cave 1F E.png",  pokeapi_areas=["granite-cave-1f"]),
        _floor("granite-cave-b1f", "B1F", "Granite Cave B1F E.png", pokeapi_areas=["granite-cave-b1f"]),
        _floor("granite-cave-b2f", "B2F", "Granite Cave B2F E.png", pokeapi_areas=["granite-cave-b2f"]),
    ]),
    _loc("meteor-falls", "Meteor Falls", [
        _floor("meteor-falls-entrance",  "Entrance",  "Meteor Falls 1F 1R E.png"),
        _floor("meteor-falls-1f-1r",     "1F, 1R",    "Meteor Falls 1F 1R E.png",  pokeapi_areas=["meteor-falls-area"]),
        _floor("meteor-falls-b1f-1r",    "B1F, 1R",   "Meteor Falls B1F 1R E.png", pokeapi_areas=["meteor-falls-b1f", "meteor-falls-back"]),
        _floor("meteor-falls-b1f-2r",    "B1F, 2R",   "Meteor Falls B1F 2R E.png", pokeapi_areas=["meteor-falls-backsmall-room"]),
    ]),
    _loc("mt-chimney", "Mt. Chimney", [
        _floor("mt-chimney", "Summit", "Mt. Chimney E.png"),
    ]),
    _loc("jagged-pass", "Jagged Pass", [
        _floor("jagged-pass", "Exterior", "Jagged Pass E.png", pokeapi_areas=["jagged-pass-area"]),
    ]),
    _loc("fiery-path", "Fiery Path", [
        _floor("fiery-path", "Interior", "Fiery Path E.png", pokeapi_areas=["fiery-path-area"]),
    ]),
    _loc("seafloor-cavern", "Seafloor Cavern", [
        # PokeAPI has a single area for all Seafloor Cavern rooms
        _floor("seafloor-cavern-entrance", "Entrance", "Seafloor Cavern Entrance E.png", pokeapi_areas=["seafloor-cavern-area"]),
    ...
    _loc("cave-of-origin", "Cave of Origin", [
        _floor("cave-of-origin-1f",  "1F",  "Cave of Origin 1F E.png",  pokeapi_areas=["cave-of-origin-1f"]),
        _floor("cave-of-origin-b1f", "B1F", "Cave of Origin B1F E.png", pokeapi_areas=["cave-of-origin-b1f", "cave-of-origin-b2f", "cave-of-origin-b3f"]),
    ]),
    _loc("shoal-cave", "Shoal Cave", [
        _floor("shoal-cave-lowtide-entrance",  "Low Tide Entrance",   "Shoal Cave Low Tide Entrance E.png",    pokeapi_areas=["shoal-cave-low-tide"]),
        _floor("shoal-cave-lowtide-inner",     "Low Tide Inner Room", "Shoal Cave Low Tide Inner Room E.png",  pokeapi_areas=["shoal-cave-b1f", "shoal-cave-b2f", "shoal-cave-b3f"]),
        _floor("shoal-cave-hightide-entrance", "High Tide Entrance",  "Shoal Cave High Tide Entrance E.png",   pokeapi_areas=["shoal-cave-high-tide"]),
        _floor("shoal-cave-hightide-inner",    "High Tide Inner Room","Shoal Cave High Tide Inner Room E.png"),
    ]),
    _loc("sky-pillar", "Sky Pillar", [
        _floor("sky-pillar-1f",   "1F",   "Sky Pillar 1F E.png",   pokeapi_areas=["sky-pillar-1f"]),
        _floor("sky-pillar-2f",   "2F",   "Sky Pillar 2F E.png"),
        _floor("sky-pillar-3f",   "3F",   "Sky Pillar 3F E.png",   pokeapi_areas=["sky-pillar-3f"]),
        _floor("sky-pillar-4f",   "4F",   "Sky Pillar 4F E.png"),
        _floor("sky-pillar-5f",   "5F",   "Sky Pillar 5F E.png",   pokeapi_areas=["sky-pillar-5f"]),
        _floor("sky-pillar-roof", "Roof", "Sky Pillar Roof E.png"),
    ]),
    _loc("victory-road", "Victory Road", [
        _floor("victory-road-1f",  "1F",  "Victory Road 1F E.png",  pokeapi_areas=["hoenn-victory-road-1f"]),
        _floor("victory-road-b1f", "B1F", "Victory Road B1F E.png", pokeapi_areas=["hoenn-victory-road-b1f", "hoenn-victory-road-b2f"]),
    ]),
]

_PLATINUM_CAVE_MAPS: list[dict] = [
    _loc("oreburgh-gate", "Oreburgh Gate", [
        _floor("oreburgh-gate-1f",  "1F",  "Oreburgh Gate 1F Pt.png",  pokeapi_areas=["oreburgh-gate-1f"]),
        _floor("oreburgh-gate-b1f", "B1F", "Oreburgh Gate B1F Pt.png", pokeapi_areas=["oreburgh-gate-b1f"]),
    ]),
    _loc("oreburgh-mine", "Oreburgh Mine", [
        _floor("oreburgh-mine-1f",  "1F",  "Oreburgh Mine 1F Pt.png",  pokeapi_areas=["oreburgh-mine-1f"]),
        _floor("oreburgh-mine-b1f", "B1F", "Oreburgh Mine B1F Pt.png", pokeapi_areas=["oreburgh-mine-b1f"]),
    ]),
    _loc("mt-coronet", "Mt. Coronet", [
        # PokeAPI splits 1F into 4 entry areas (from-exterior, route-207, route-211, route-216)
        _floor("mt-coronet-1f",       "1F",       "Mt. Coronet 1F Pt.png",       pokeapi_areas=["mt-coronet-1f-from-exterior", "mt-coronet-1f-route-207", "mt-coronet-1f-route-211", "mt-coronet-1f-route-216"]),
        _floor("mt-coronet-2f",       "2F",       "Mt. Coronet 2F Pt.png",       pokeapi_areas=["mt-coronet-2f"]),
        _floor("mt-coronet-3f",       "3F",       "Mt. Coronet 3F Pt.png",       pokeapi_areas=["mt-coronet-3f"]),
        _floor("mt-coronet-4f",       "4F",       "Mt. Coronet 4F Pt.png",       pokeapi_areas=["mt-coronet-4f", "mt-coronet-4f-small-room"]),
        _floor("mt-coronet-5f",       "5F",       "Mt. Coronet 5F Pt.png",       pokeapi_areas=["mt-coronet-5f"]),
        _floor("mt-coronet-6f",       "6F",       "Mt. Coronet 6F Pt.png",       pokeapi_areas=["mt-coronet-6f"]),
        _floor("mt-coronet-exterior", "Exterior", "Mt. Coronet Exterior Pt.png", pokeapi_areas=["mt-coronet-exterior-blizzard", "mt-coronet-exterior-snowfall"]),
        _floor("mt-coronet-summit",   "Summit",   "Spear Pillar Pt.png"),
    ]),
    _loc("wayward-cave", "Wayward Cave", [
        _floor("wayward-cave-1f", "1F", "Wayward Cave 1F Pt.png", pokeapi_areas=["wayward-cave-1f"]),
        _floor("wayward-cave-2f", "2F", "Wayward Cave 2F Pt.png", pokeapi_areas=["wayward-cave-b1f"]),
    ]),
    _loc("mt-coronet-b1f", "Mt. Coronet (Underground)", [
        _floor("mt-coronet-b1f", "B1F", "Mt. Coronet B1F Pt.png", pokeapi_areas=["mt-coronet-b1f"]),
    ]),
    _loc("iron-island", "Iron Island", [
        _floor("iron-island-1f",  "1F",  "Iron Island 1F Pt.png",  pokeapi_areas=["iron-island-area", "iron-island-1f"]),
        _floor("iron-island-b1f", "B1F", "Iron Island B1F Pt.png", pokeapi_areas=["iron-island-b1f-left", "iron-island-b1f-right"]),
        _floor("iron-island-b2f", "B2F", "Iron Island B2F Pt.png", pokeapi_areas=["iron-island-b2f-left", "iron-island-b2f-right", "iron-island-b3f"]),
    ]),
    _loc("victory-road-sinnoh", "Victory Road", [
        _floor("victory-road-sinnoh-1f", "1F", "Victory Road 1F Pt.png", pokeapi_areas=["sinnoh-victory-road-1f", "sinnoh-victory-road-inside"]),
        _floor("victory-road-sinnoh-2f", "2F", "Victory Road 2F Pt.png", pokeapi_areas=["sinnoh-victory-road-2f", "sinnoh-victory-road-inside-b1f"]),
        _floor("victory-road-sinnoh-3f", "3F", "Victory Road 3F Pt.png", pokeapi_areas=["sinnoh-victory-road-b1f", "sinnoh-victory-road-inside-exit"]),
    ]),
    _loc("snowpoint-temple", "Snowpoint Temple", [
        # Game labels 1F–5F; PokeAPI uses 1F + B1F–B5F (6 levels)
        _floor("snowpoint-temple-1f", "1F", "Snowpoint Temple 1F Pt.png", pokeapi_areas=["snowpoint-temple-1f"]),
        _floor("snowpoint-temple-2f", "2F", "Snowpoint Temple 2F Pt.png", pokeapi_areas=["snowpoint-temple-b1f"]),
        _floor("snowpoint-temple-3f", "3F", "Snowpoint Temple 3F Pt.png", pokeapi_areas=["snowpoint-temple-b2f"]),
        _floor("snowpoint-temple-4f", "4F", "Snowpoint Temple 4F Pt.png", pokeapi_areas=["snowpoint-temple-b3f", "snowpoint-temple-b4f"]),
        _floor("snowpoint-temple-5f", "5F", "Snowpoint Temple 5F Pt.png", pokeapi_areas=["snowpoint-temple-b5f"]),
    ]),
...
_UNOVA_CAVE_MAPS: list[dict] = [
    _loc("wellspring-cave", "Wellspring Cave", [
        # PokeAPI has a single area for all of Wellspring Cave
        _floor("wellspring-cave-b1f", "B1F", "Wellspring Cave B1F BW.png", pokeapi_areas=["wellspring-cave-area"]),
        _floor("wellspring-cave-b2f", "B2F", "Wellspring Cave B2F BW.png"),
    ]),
    _loc("relic-castle", "Relic Castle", [
        # PokeAPI has 4 area sections (a–d); distributed across floors by depth
        _floor("relic-castle-1f",  "1F",  "Relic Castle 1F BW.png",  pokeapi_areas=["relic-castle-a"]),
        _floor("relic-castle-b1f", "B1F", "Relic Castle B1F BW.png", pokeapi_areas=["relic-castle-b"]),
        _floor("relic-castle-b2f", "B2F", "Relic Castle B2F BW.png", pokeapi_areas=["relic-castle-c"]),
        _floor("relic-castle-b3f", "B3F", "Relic Castle B3F BW.png", pokeapi_areas=["relic-castle-d"]),
    ...
    _loc("castelia-sewers", "Castelia Sewers", [
        _floor("castelia-sewers-b1f", "B1F", "Castelia Sewers BW.png", pokeapi_areas=["castelia-sewers-area", "castelia-sewers-unknown-area-38"]),
    ]),
    _loc("cold-storage", "Cold Storage", [
        _floor("cold-storage-b1f", "B1F", "Cold Storage BW.png", pokeapi_areas=["cold-storage-area"]),
    ]),
    _loc("chargestone-cave", "Chargestone Cave", [
        # PokeAPI names the floors 1f/b1f/b2f; game labels them B1F/B2F/B3F
        _floor("chargestone-cave-b1f", "B1F", "Chargestone Cave B1F BW.png", pokeapi_areas=["chargestone-cave-1f"]),
        _floor("chargestone-cave-b2f", "B2F", "Chargestone Cave B2F BW.png", pokeapi_areas=["chargestone-cave-b1f"]),
        _floor("chargestone-cave-b3f", "B3F", "Chargestone Cave B3F BW.png", pokeapi_areas=["chargestone-cave-b2f"]),
    ]),
    _loc("celestial-tower", "Celestial Tower", [
        _floor("celestial-tower-2f", "2F", "Celestial Tower 2F BW.png", pokeapi_areas=["celestial-tower-2f"]),
        _floor("celestial-tower-3f", "3F", "Celestial Tower 3F BW.png", pokeapi_areas=["celestial-tower-3f"]),
        _floor("celestial-tower-4f", "4F", "Celestial Tower 4F BW.png", pokeapi_areas=["celestial-tower-4f"]),
        _floor("celestial-tower-5f", "5F", "Celestial Tower 5F BW.png", pokeapi_areas=["celestial-tower-5f"]),
    ]),
    _loc("twist-mountain", "Twist Mountain", [
        _floor("twist-mountain-1f",  "1F",  "Twist Mountain 1F BW.png"),
        _floor("twist-mountain-b1f", "B1F", "Twist Mountain B1F BW.png", pokeapi_areas=["twist-mountain-b1f-3f"]),
        _floor("twist-mountain-b2f", "B2F", "Twist Mountain B2F BW.png", pokeapi_areas=["twist-mountain-b4f"]),
    ]),
    _loc("dragonspiral-tower", "Dragonspiral Tower", [
        _floor("dragonspiral-tower-exterior", "Exterior", "Dragonspiral Tower Exterior BW.png", pokeapi_areas=["dragonspiral-tower-outside", "dragonspiral-tower-entrance"]),
        _floor("dragonspiral-tower-1f",       "1F",       "Dragonspiral Tower 1F BW.png",       pokeapi_areas=["dragonspiral-tower-1f"]),
        _floor("dragonspiral-tower-2f",       "2F",       "Dragonspiral Tower 2F BW.png",       pokeapi_areas=["dragonspiral-tower-2f"]),
        ...
        _floor("dragonspiral-tower-7f",       "7F",       "Dragonspiral Tower 7F BW.png",       pokeapi_areas=["dragonspiral-tower-7f"]),
    ]),
    _loc("victory-road", "Victory Road", [
        _floor("victory-road-exterior", "Exterior", "Victory Road Exterior BW.png", pokeapi_areas=["unova-victory-road-outside"]),
        _floor("victory-road-1f",       "1F",       "Victory Road 1F BW.png"),
        _floor("victory-road-2f",       "2F",       "Victory Road 2F BW.png",       pokeapi_areas=["unova-victory-road-7f"]),
    ]),
    # BW2-only locations
    _loc("virbank-complex", "Virbank Complex", [
        _floor("virbank-complex-outside", "Outside", "Virbank Complex Outside BW2.png", pokeapi_areas=["virbank-complex-outer"]),
        _floor("virbank-complex-inside",  "Inside",  "Virbank Complex Inside BW2.png",  pokeapi_areas=["virbank-complex-inner"]),
    ]),
    _loc("seaside-cave", "Seaside Cave", [
        _floor("seaside-cave-1f",  "1F",  "Seaside Cave 1F BW2.png",  pokeapi_areas=["seaside-cave-1f"]),
        _floor("seaside-cave-b1f", "B1F", "Seaside Cave B1F BW2.png", pokeapi_areas=["seaside-cave-b1f"]),
    ]),
    _loc("giant-chasm", "Giant Chasm", [
        _floor("giant-chasm-exterior", "Exterior", "Giant Chasm BW2.png",        pokeapi_areas=["giant-chasm-area"]),
        _floor("giant-chasm-forest",   "Forest",   "Giant Chasm Forest BW2.png", pokeapi_areas=["giant-chasm-forest"]),
        _floor("giant-chasm-cave",     "Cave",     "Giant Chasm Cave BW2.png",   pokeapi_areas=["giant-chasm-forest-cave"]),
    ]),
]

_KALOS_CAVE_MAPS: list[dict] = [
    _loc("connecting-cave", "Connecting Cave", [
        _floor("connecting-cave-1f", "1F", "Connecting Cave XY.png", pokeapi_areas=["connecting-cave-area"]),
    ]),
    _loc("glittering-cave", "Glittering Cave", [
        _floor("glittering-cave", "Interior", "Glittering Cave XY.png", pokeapi_areas=["glittering-cave-unknown-area-303", "glittering-cave-unknown-area-304"]),
    ]),
    _loc("frost-cavern", "Frost Cavern", [
        _floor("frost-cavern-1f",  "1F",  "Frost Cavern 1F XY.png",  pokeapi_areas=["frost-cavern-unknown-area-313", "frost-cavern-unknown-area-314"]),
        _floor("frost-cavern-b1f", "B1F", "Frost Cavern B1F XY.png", pokeapi_areas=["frost-cavern-unknown-area-315", "frost-cavern-unknown-area-316"]),
        _floor("frost-cavern-b2f", "B2F", "Frost Cavern B2F XY.png", pokeapi_areas=["frost-cavern-unknown-area-317"]),
    ]),
    _loc("terminus-cave", "Terminus Cave", [
        # PokeAPI splits Terminus into 1f (entrance) + b1f-left/right + b2f + zygarde-chamber
        _floor("terminus-cave-b1f", "B1F", "Terminus Cave B1F XY.png", pokeapi_areas=["terminus-cave-1f"]),
        _floor("terminus-cave-b2f", "B2F", "Terminus Cave B2F XY.png", pokeapi_areas=["terminus-cave-b1f-left", "terminus-cave-b1f-right"]),
        _floor("terminus-cave-b3f", "B3F", "Terminus Cave B3F XY.png", pokeapi_areas=["terminus-cave-b2f", "terminus-cave-zygardes-chamber"]),
    ]),
    _loc("victory-road", "Victory Road", [
        _floor("victory-road-exterior", "Exterior", "Victory Road Exterior XY.png", pokeapi_areas=["kalos-victory-road-outside"]),
        _floor("victory-road-1f",       "1F",       "Victory Road 1F XY.png",       pokeapi_areas=["kalos-victory-road-unknown-area-322", "kalos-victory-road-unknown-area-324"]),
        _floor("victory-road-2f",       "2F",       "Victory Road 2F XY.png",       pokeapi_areas=["kalos-victory-road-unknown-area-326", "kalos-victory-road-unknown-area-328"]),
    ]),
]
